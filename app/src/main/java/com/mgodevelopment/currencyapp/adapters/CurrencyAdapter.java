package com.mgodevelopment.currencyapp.adapters;
...
import com.mgodevelopment.currencyapp.R;

/**
 * Created by Martin on 9/17/2016.
 */
public class CurrencyAdapter extends BaseAdapter {
    ...
    @Override
    public int getCount() {
        return Constants.CURRENCY_CODES.length;
